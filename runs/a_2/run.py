...
from nuclear_qmc.wave_function.jastro_neural_network import build_jastro_nn_2_body
...
key, psi_prefactor, _ = build_jastro_nn_2_body(key, n_dense, particle_pairs, n_hidden_layers=2)
psi_params = jnp.load(psi_param_file)
key, params = optimize_wave_function(
    n_proton
    , n_neutron
    , psi_prefactor
    , psi_params
