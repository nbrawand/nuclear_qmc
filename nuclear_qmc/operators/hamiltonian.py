...
def potential_energy_psi(psi
    ...
    v_psi += sigma(psi, r_coords, spin_exchange_indices, second_term_coefficients)
    return v_psi
...
def hamiltonian_psi(psi
    ...
    """
    ke_psi = kinetic_energy_operator(psi, r_coords)
    v_psi = potential_energy_psi(psi
                                 , r_coords
                                 , particle_pairs
                                 , particle_triplets
                                 , spin_exchange_indices)
...
def get_local_energy(psi
    ...
    """
    h_psi = hamiltonian_psi(psi
                            , r_coords
                            , particle_pairs
                            , particle_triplets
                            , spin_exchange_indices
                            , kinetic_energy_operator=kinetic_energy_operator)
    psi_r = psi(r_coords)
